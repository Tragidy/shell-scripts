...
wget -O webmin.deb http://prdownloads.sourceforge.net/webadmin/webmin_1.820_all.deb &
wait $!
...
# Install Webmin
echo "Downloading Webmin from Source Forge"
wget -O webmin.rpm http://prdownloads.sourceforge.net/webadmin/webmin-1.820-1.noarch.rpm &
wait $!
echo "Installing Webmin........................"
echo "This can take a long time on ARM or Small VPS systems."
